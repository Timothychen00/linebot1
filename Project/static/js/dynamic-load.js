...
function find(type='dynamic',key_v=null,value_v=null){
//    alert(2);
    ...
    if (type=='dynamic')
    {
        if (search_mode=='total')
            ...
            url='/customers/?key='+key_v+'&value='+value_v+"&type=json&start="+start+"&length=25&month="+search_mode;
    }else{
        place.innerHTML='';
        if (search_mode=='total')
        {
